...
Public Class StudentCrystalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "NagarNigamVB.StudentCrystalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStudentCrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StudentCrystalReport = New StudentCrystalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
